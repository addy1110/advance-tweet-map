    ...
    if(request.method == 'POST') {
        request.on('data',function(chunk){
            ...
            try
            {
                ...
                requestVar({
                    uri: 'http://search-sentiment-tweets-zwd7yfbgyq5kkp27u5cgiptzfa.us-east-1.es.amazonaws.com/domain/sentimentaltweets',
                    method: "POST",
                    json: chunk
        ...
        var client = new elasticsearch.Client({
            host: 'search-sentiment-tweets-zwd7yfbgyq5kkp27u5cgiptzfa.us-east-1.es.amazonaws.com/domain/sentimentaltweets/'
        });
        hits = '';
        url = request.url;
        client.search({
